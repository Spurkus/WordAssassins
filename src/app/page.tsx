  ...
  return (
    <>
      ...
      <div className="mx-2 my-16 flex w-full flex-col justify-between text-center">
        <h1 className="inline-block bg-gradient-to-b from-yellow-500 via-primary-100 to-red-700 bg-clip-text font-black text-transparent ~mt-0/28 ~leading-[4rem]/[7.5rem] ~/lg:~text-[4.2rem]/[8rem]">
          <button
